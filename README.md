...
Скрипт для автоматической установки Arch Linux на **пустой GPT** диск.<br/>
(чуть позже обновлю скрипт с выбором GPT и MBR)<br/>
<br/>
...
Данный скрипт подходит лишь для установки на абсолютно **пустой** диск с **GPT** разметкой диска,<br/>
на которой скрипт во время установки создаст такие разделы:<br/>
- sda1 - **boot** раздел (1024 Mb)<br/>
- sda2 - **swap** раздел  (4096 Mb)<br/>
- sda3 - **root** раздел (остальное место на диске sda)<br/>

Во время установки, скрипт будет давать возможность выбора:<br/>
