...
с возможностью выбора GPT или MBR разметк, все данные на sda диске будут удалены.<br/>
<br/>
Если вы не знаете какая вам нужна раметка и чем вообще они отличаются друг от друга GPT и MBR,<br/>
